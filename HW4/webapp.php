...
$f_to_u = array();
$lines = file("URLtoHTML_mercury.csv");	// Get rid of the header
...
if ($query)
{
	...
	$select = isset($_REQUEST['c'])? $_REQUEST['c'] : "d_select";
...
<html>
	...
	<body>
		<form accept-charset="utf-8" method="get">
			...
			<input type="submit"/>
			<label for="c">Toggle for PageRank Ordering:</label>
    		<input type="checkbox" id="c" name="c" value="pr_select" <?php if(isset($_REQUEST['c']) && $select == "pr_select") { echo 'checked="checked"';} ?>/>
		</form>
