...
fetch = pd.read_csv("fetch_mercurynews.csv", header=None)
...
visit = pd.read_csv("visit_mercurynews.csv", header=None)
...
urls = pd.read_csv("urls_mercurynews.csv", header=None)
...
with open('CrawlReport_mercurynews.txt', 'w') as fp:
	fp.write(out)
