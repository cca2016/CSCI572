...
public class MyCrawler extends WebCrawler {
	...
	// This processes EVEN REPEATS
	// referringPage - page w/ url found
	...
	public boolean shouldVisit(Page referringPage, WebURL url){
		...
		boolean typeCheck = typeStr.contains("html") | typeStr.contains("pdf") | typeStr.contains("gif") | typeStr.contains("jpeg") | typeStr.contains("png");
